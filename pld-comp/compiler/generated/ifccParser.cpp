...
tree::TerminalNode* ifccParser::SignVarExprContext::SIGN() {
  return getToken(ifccParser::SIGN, 0);
}

tree::TerminalNode* ifccParser::SignVarExprContext::VAR() {
  return getToken(ifccParser::VAR, 0);
}

ifccParser::SignVarExprContext::SignVarExprContext(ExprContext *ctx) { copyFrom(ctx); }

antlrcpp::Any ifccParser::SignVarExprContext::accept(tree::ParseTreeVisitor *visitor) {
  if (auto parserVisitor = dynamic_cast<ifccVisitor*>(visitor))
    return parserVisitor->visitSignVarExpr(this);
  else
    return visitor->visitChildren(this);
}
//----------------- Add_subContext ------------------------------------------------------------------
...
//----------------- SignConstExprContext ------------------------------------------------------------------

tree::TerminalNode* ifccParser::SignConstExprContext::SIGN() {
  return getToken(ifccParser::SIGN, 0);
}

tree::TerminalNode* ifccParser::SignConstExprContext::CONST() {
  return getToken(ifccParser::CONST, 0);
}

ifccParser::SignConstExprContext::SignConstExprContext(ExprContext *ctx) { copyFrom(ctx); }

antlrcpp::Any ifccParser::SignConstExprContext::accept(tree::ParseTreeVisitor *visitor) {
  if (auto parserVisitor = dynamic_cast<ifccVisitor*>(visitor))
    return parserVisitor->visitSignConstExpr(this);
  else
    return visitor->visitChildren(this);
}
//----------------- ConstExprContext ------------------------------------------------------------------
...
ifccParser::ExprContext* ifccParser::expr(int precedence) {
  ...
  try {
    ...
    case 2: {
      _localctx = _tracker.createInstance<SignConstExprContext>(_localctx);
      _ctx = _localctx;
      previousContext = _localctx;
      setState(55);
      match(ifccParser::SIGN);
      setState(56);
      match(ifccParser::CONST);
      break;
    }
    ...
    case 4: {
      _localctx = _tracker.createInstance<SignVarExprContext>(_localctx);
      _ctx = _localctx;
      previousContext = _localctx;
      setState(58);
      match(ifccParser::SIGN);
...
std::vector<std::string> ifccParser::_symbolicNames = {
  "", "", "", "", "", "", "", "", "", "RETURN", "CONST", "INT", "VAR", "SIGN", 
  "ADD_SUB", "MULT_DIV", "COMMENT", "DIRECTIVE", "WS"
};
...
ifccParser::Initializer::Initializer() {
  ...
  _serializedATN = {
    ...
    0x3, 0x14, 0x54, 0x4, 0x2, 0x9, 0x2, 0x4, 0x3, 0x9, 0x3, 0x4, 0x4, 0x9, 
    ...
    0x3, 0x6, 0x3, 0x6, 0x3, 0x6, 0x3, 0x6, 0x3, 0x6, 0x5, 0x6, 0x43, 0xa, 
    0x6, 0x3, 0x6, 0x3, 0x6, 0x3, 0x6, 0x3, 0x6, 0x3, 0x6, 0x3, 0x6, 0x7, 
    0x6, 0x4b, 0xa, 0x6, 0xc, 0x6, 0xe, 0x6, 0x4e, 0xb, 0x6, 0x3, 0x7, 0x3, 
    0x7, 0x3, 0x7, 0x3, 0x7, 0x3, 0x7, 0x2, 0x3, 0xa, 0x8, 0x2, 0x4, 0x6, 
    0x8, 0xa, 0xc, 0x2, 0x2, 0x2, 0x57, 0x2, 0xe, 0x3, 0x2, 0x2, 0x2, 0x4, 
